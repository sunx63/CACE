...
#r_prime: reduced number of random effects

cace_1side_parallel_lambda <- function(r,k=1,Q,J,data,x0,x1,init,col.clinic,col.trt,col.D,col.Y,niter,tol,Share,r_prime){ 
  start_time <- Sys.time()
